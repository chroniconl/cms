...
export const findTagsThatAlreadyExistInDatabase = async (tags: string[]): Promise<TagResponse> => {
...
export const createTagsInDatabase = async (tags: string[], userData: {id: string}): Promise<TagResponse> => {
...
export const getTagsThatAlreadyExistInDatabase = async (tags: string[]): Promise<TagResponse> => {
	const { data: tagsThatExistData, error: tagsThatExistError } = await supabase
		.from('tags')
		.select('id, name')
		.in('name', tags)
...
export const createTagsRelationshipsInDatabase = async (tags: TagCollection, additionalInfo: {
	tagAuthorId: string
	postId: string
}): Promise<TagResponse> => {
