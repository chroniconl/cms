			...
			<div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-3 md:gap-12 md:px-6">
				...
				<div className="grid gap-4">
					...
					<div className="flex gap-4">
						<Link href="https://x.com/chroniconl_src" className="text-muted-foreground hover:text-primary" prefetch={false}>
							<TwitterIcon className="h-6 w-6" />
							<span className="sr-only">Twitter</span>
						</Link>
						<Link href="https://github.com/matthewbub/chroniconl-cms" className="text-muted-foreground hover:text-primary" prefetch={false}>
