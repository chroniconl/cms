        ...
        <div className="flex lg:flex-1">
          <Link href="/" className="flex gap-2">
            <div className="px-4 py-2 flex items-center justify-center">
              <span
                className={
                  "text-stone-900 font-black leading-tighter whitespace-nowrap text-2xl"
                }
              >
                {"Chroniconl"}
              </span>
              ...
              <PopoverPanel className="absolute inset-x-0 top-0 -z-10 bg-white pt-14 shadow-lg ring-1 ring-stone-900/5">
                <div className="mx-auto grid max-w-7xl grid-cols-4 gap-x-4 px-6 py-10 lg:px-8 xl:gap-x-8">
                  {products.map((item) => (
                    <div
                      key={item.name}
                      className="group relative rounded-md p-6 text-sm leading-6 hover:bg-stone-50"
                    >
                      <div className="flex h-11 w-11 items-center justify-center rounded-md bg-stone-50 group-hover:bg-white">
                        <item.icon
                          className="h-6 w-6 text-stone-600 group-hover:text-indigo-600"
                          aria-hidden="true"
                        />
                      </div>
                      <a
                        href={item.href}
                        className="mt-6 block font-semibold text-stone-900"
                      >
                        {item.name}
