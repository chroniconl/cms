...
export default async function DocumentSlugEdit({
	...
	try {
		...
		return (
			<div className="w-full rounded-md grid grid-cols-12 gap-4 md:gap-6">
				<section className="col-span-12 md:col-span-8 gap-1 prose dark:prose-invert max-w-full flex flex-col">
					<TitleForm title={postData.title} id={postData.id} />
					<Card className="p-2">
						<TipTap defaultValue={postData.content} params={params} />
					</Card>
				</section>
				<section className="h-full col-span-12 md:col-span-4 flex flex-col gap-5">
