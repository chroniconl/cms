...
export default function PublishDetailsForm({
	...
	const { control, handleSubmit } = useForm<PublishDetailsFormProps>({
		defaultValues: {
			...
			publishDateTime: publishDateTime ? convertTimeString(publishDateTime) : "6:00 AM"
		}
	});
	...
	return (
		<Card className="flex flex-col gap-4">
			...
			<form className="px-4 pb-6 rounded-md space-y-10" role="form" onSubmit={handleSubmit(onSubmit)}>
							...
							<Controller
								...
								render={({ field }) => (
									<Select {...field} onValueChange={field.onChange}>
										...
										<SelectContent>
											{["4:00 AM", "5:00 AM", "6:00 AM", "7:00 AM", "8:00 AM", "9:00 AM", "10:00 AM", "11:00 AM", "12:00 PM", "1:00 PM", "2:00 PM", "3:00 PM"].map((time) => (
