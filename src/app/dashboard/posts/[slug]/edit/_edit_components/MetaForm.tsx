...
export default function MetaForm({
  ...
  const setCurrentCategory = useMetaFormStore(
  ...
  const setProps__IntoStateOnLoad = () => {
    const publishDate = isValidDate(props__publishDate)
      ? parseISO(props__publishDate)
      : null;
    const createdAt = isValidDate(props__createdAt)
      ? parseISO(props__createdAt)
      : null;
        ...
        <div id="meta-form--category" className="mt-4 grid grid-cols-12 gap-4">
          <div className="col-span-10">
            ...
            <Select
              ...
              onValueChange={(value) => updateCategory(value, props__id)}
