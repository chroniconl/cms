...
export default function MetaForm({
	...
	const { control, handleSubmit, setValue: setValueForPostMetadata } = useForm<MetaFormProps>({
		defaultValues: {
			title: title || "",
		...
		<Card className="flex flex-col gap-4">
			...
			<form className="px-4 pb-6 rounded-md space-y-[20px]" role="form" onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="grid grid-cols-12 gap-4">
					...
					<div className="col-span-2 flex items-end justify-end h-full">
						<Button variant="outline" onClick={() => setAvatarModalOpen(true)} type="button">
			...
			<Dialog open={avatarModalOpen} onOpenChange={setAvatarModalOpen}>
				<DialogContent className="sm:max-w-[425px]">
					...
					<form onSubmit={handleAuthorSubmit(onAuthorSubmit)} className="grid gap-4 py-4">
							...
							<div className="flex justify-start items-start gap-6">
								<Avatar>
									...
									<AvatarFallback className="w-full h-full">
										<img src="https://utfs.io/f/d4271cec-49ca-475a-ab84-df354ce7e35a-h5faa7.png" alt="Avatar" />
									</AvatarFallback>
								</Avatar>
								<UploadButton
									className="w-fit"
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Controller
								name="name"
								control={authorControl}
								render={({ field }) => <Input id="name" placeholder="Marcus Bub" className="col-span-3" {...field} />}
							/>
						</div>
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Controller
								name="linkTo"
								control={authorControl}
								render={({ field }) => <Input id="link_to" placeholder="https://chroniconl.com" className="col-span-3" {...field} />}
							/>
						</div>
						<DialogFooter>
