...
export default function Message({
	...
	const formSubmissions = useFormSubmissionsStore((state) => state.formSubmissions)
	const setFormSubmissions = useFormSubmissionsStore((state) => state.setFormSubmissions)
	...
	const handleMarkAsSeen = async () => {
		...
		const newFormSubmissions = formSubmissions.map((formSubmission) => (formSubmission.id === id ? { ...formSubmission, status: data } : formSubmission))
