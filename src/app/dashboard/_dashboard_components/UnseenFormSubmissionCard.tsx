...
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from "@chroniconl/ui/card"

export default function UnseenFormSubmissionCard({ count = 0 }: { count?: number }) {
	...
	return (
		<Card className="w-full">
			...
			<CardFooter>
				<LinkAsButton href="/dashboard/form-submissions">Take a look</LinkAsButton>
			</CardFooter>
		</Card>
	)
}