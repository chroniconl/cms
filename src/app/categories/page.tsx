...
import ViewBy from "@/components/general/ViewBy";
...
export default async function Page() {
	...
	const validCategoriesWithPosts = categoriesWithPosts.filter((item) => item !== null);
	...
	return (
		<PublicLayout>
			<div className="px-2 md:px-4 md:mt-10 max-w-7xl mx-auto">
				<ViewBy
					type="categories"
					data={categorizedPosts}
				/>
			</div>
		</PublicLayout>
	);
